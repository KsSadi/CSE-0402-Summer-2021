...
$status = 1;
$sql="INSERT INTO  batches(department,batch,status) VALUES(:department,:batch,:status)";
...
<head>
	...
	<title>SUB Blood Bank | Add Batches</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8 control-label" style="    text-align: left !important;">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label" for="batch">Batch</label>
												<div class="col-sm-8 ">
