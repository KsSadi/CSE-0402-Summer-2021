...
if(isset($_POST['submit'])){
	// get batch id from submitted data
...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,department,batch,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:department,:batch,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<head>
	...
	<title>SUB Blood Bank| Admin Add Donor</title>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="department">Department<span style="color:red">*</span></label>
...
<textarea class="form-control" name="message" required> </textarea>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													...
													<button class="btn btn-primary" name="submit" type="submit">Add Donor</button>
												</div>
											</div>
